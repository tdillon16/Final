...
var base = Rebase.createClass({
  apiKey: "AIzaSyBcFIijbNzT2uC8iXXbf-bs7avUdsJ-afc",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix-final-master.firebaseapp.com", // replace with your Firebase application's database URL
})
      ...
      return (
        <div className="col-sm-12">
          <Gmaps width={'100%'}
                   ...
                   lng={'-87.6285782'}
                   zoom={11}
                   loadingMessage={'Theaters near you...'}
