        ...
        <div className="col-sm-12">
          <ul className="nav nav-pills">
            <li className={this.props.currentView === 'latest' ? "active" : ""}>
              <a href="#" onClick={() => this.viewChanged('latest')}>Latest Releases</a></li>
            <li className={this.props.currentView === 'alpha' ? "active" : ""}>
              <a href="#" onClick={() => this.viewChanged('alpha')}>A-Z</a></li>
            <li className={this.props.currentView === 'map' ? "active" : ""}>
              <a href="#" onClick={() => this.viewChanged('map')}>Where to Watch</a></li>
